...
\providecommand{\CGTVer}[1]{}%
\providecommand{\NotCGTVer}[1]{#1}%
\else%
...
\documentclass[a4paper,USenglish,cleveref,autoref,thm-restate, nolineno]{compgeomtop}%

\providecommand{\CGTVer}[1]{#1}%
\providecommand{\NotCGTVer}[1]{}%
\fi
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CGT Style: Defining theorem like environments
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
