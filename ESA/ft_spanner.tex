...
\stav{changed table after removing Section 4}
...
\stav{The following lemma is similar in flavor and proof to a technical
lemma used to prove the spanning property of the $\Theta$-graph. The
proof is therefore delegated to the appendix.
}
...
\subsection{Proof of \TPDF{\lemref{cone_edge:triangles}}{{cone_edge:triangles}}}
\apndlab{cone_edge:triangles}
...
\subsection{Proof of \TPDF{\lemref{shrink:triangles}}{{shrink:triangles}}}
\apndlab{shrink:triangles}
