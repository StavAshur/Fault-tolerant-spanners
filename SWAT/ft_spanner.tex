...
In the final result, moved to \apndref{rectangles} due to space constraints,
...
See \apndref{rectangles} for details of the precise result.
...
\begin{lemma}\RefProofInAppendix{d:1}
	\lemlab{d:1}%
	%
...
\end{lemma}
\begin{proof:in:appendix:e}{\lemref{d:1}}{d:1}
...
\begin{lemma}\RefProofInAppendix{d:D}
	\lemlab{d:D}%
	...
	$\Of( n \log^d n)$.
\end{lemma}
\begin{proof:in:appendix:e}{\lemref{d:D}}{d:D}
