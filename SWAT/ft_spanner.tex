...
\begin{theorem}\RefProofInAppendix{refine:d:w}
    \lemlab{refine:d:w}%
	%
...
\begin{proof:in:appendix:e}{\lemref{refine:d:w}}{refine:d:w}
    \begin{figure}[ht]
...
\begin{lemma}\RefProofInAppendix{w:l:s:regions}
    ...
    $\pb$.
\end{lemma}
\begin{proof:in:appendix:e}{\lemref{w:l:s:regions}}{w:l:s:regions}
...
\begin{lemma}\RefProofInAppendix{shrink:shrank}
...
\begin{proof:in:appendix:e}{\lemref{shrink:shrank}}{shrink:shrank}
...
\begin{claim}\RefProofInAppendix{c:t:connected}
...
\begin{proof:in:appendix:e}{\clmref{c:t:connected}}{c:t:connected}
...
\begin{lemma}\RefProofInAppendix{proof_l_b_triangles}
...
\begin{proof:in:appendix:e}{\lemref{l:b:triangles}}{proof_l_b_triangles}
...
\apndref{l:s:triangle:details} for details).
...
\begin{lemma}\RefProofInAppendix{good:jump:traps:p}
...
\begin{proof:in:appendix:e}{\lemref{good:jump:traps}}{good:jump:traps:p}
...
\begin{lemma}\RefProofInAppendix{p:narrow:traps:d}
...
\begin{proof:in:appendix:e}{\lemref{narrow:traps:decomp}}{p:narrow:traps:d}
    We show a somewhat suboptimal but simple construction. A $t$-nice
    polygon has at most $t$ edges.  Let $\psi$ be the sensitivity of
    $\Body$, and place a minimum set $\PS$ of points on the boundary
...
In \apndref{l:s:qspd:details} we prove the properties regarding
the computational and combinatorial complexity of \QSPD{}s that are used
in the proof of \thmref{a:l:s:rectangles}%}.
...
\begin{lemma}
    \lemlab{cases}%
	%
    Assume that $\delta < 1/2$, and $\gConst \geq \ceil{20/\eps + 20/\delta}$.  Consider a
...
\begin{lemma}\RefProofInAppendix{local:spanner:x}
...
\end{lemma}
\begin{proof:in:appendix:e}{\lemref{local:spanner}}{local:spanner:x}
...
\begin{theorem}\RefProofInAppendix{rectangles:3}
...
\end{theorem}
\begin{proof:in:appendix:e}{\thmref{a:l:s:rectangles}}{rectangles:3}
