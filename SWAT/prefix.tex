...
\providecommand{\SWATVer}[1]{}%
\providecommand{\NotSWATVer}[1]{#1}%
\else%
...
\documentclass[a4paper,USenglish,cleveref,autoref,thm-restate, nolineno]%
{lipics-v2021}
\nolinenumbers

%\hideLIPIcs 
\providecommand{\SWATVer}[1]{#1}%
\providecommand{\NotSWATVer}[1]{}%
\fi
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SWAT Style: Defining theorem like environments
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\SarielThanks}[1]{\thanks{Department of Computer Science;
      ...
      61801, USA; %
      \href{mailto:sariel.spam@illinois.edu}%
      {sariel@illinois.edu}; %
...
\newcommand{\QSPD}{\Term{OSPD}\xspace}

\newcommand{\StavThanks}[1]{%
   \thanks{Department of Computer Science; University of Illinois; 201
      N. Goodwin Avenue; Urbana, IL, 61801, USA; %
      \href{mailto:stava2.spam@illinois.edu}%
      {stava2@illinois.edu}; %
      \url{https://publish.illinois.edu/stav-ashur}. %
      #1}}
...
\newcommand{\sariel}[1]{%
	\todo[author=Sariel,inline,color=blue!25]{#1}}

\newcommand{\stav}[1]{
	\todo[author=stav,inline,color=black!25]{#1}}
...
\newcommand{\InFullVer}{\SWATVer{(Proof in full version
      \cite{ah-lsr-22}.) }}
