...
=======
\paragraph{Euclidean graph.}
>>>>>>> 48bfeb7bc92827134bfa98a65e61c1ac58819645
...
\begin{defn}
    ...
    \dY{\pa}{\pb}$.  For a point set $\PS$, a \emphOnly{well-separated
       pair decomposition} (\emphOnly{\WSPD{}}) of $\PS$ with
...
\begin{defn}
    ...
    $\pa,\pb \in \disk \subseteq R$. The \emphi{safe graph} for $\PS$
...
The \emphi{homothet} of a convex shape $\CC$ is a scaled and
...
and results in the \emphi{$\CC$-Delaunay} graph of $\PS$
...
\Sariel{Please add relevant citations to this modified Delaunay
   triangulations, since this is all well known.}
...
\RestatementOf{\clmlab{d:t:connected}}%
{%
   \ClaimDelConnected{}
}
