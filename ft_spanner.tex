...
Sariel's construction:
1. Take the original triangle (with center (0,0)?) denoted $(a,b,c)$, and for every point $p$ compute the 3d point $(<p,a>, <p,b>, <p,c>)$.
2. Compute a QSPD for the 3d point set $P'$ from first step
3. Refine the QSPD to get an SSPD
4. For every pair $(A,B)$ divide $B$ into $O(\eps^{-2})$ parallelogram cells and connect all points of $A$ to the skewed-lowest point of each cell.  
