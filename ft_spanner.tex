...
\SaveContent{\LemmaRefineDWBody}{%
   ...
   refine it, into a $(1/\eps)$-\SSPD $\WS'$, such that each pair
...
\begin{proof}
    ...
    \begin{figure}[h]
        ...
        \caption{An illustration of the settings in the proof of \lemref{w:l:s:regions}}
        \figlab{ellipse}
    \end{figure}
...
A graph $\G=(\PS, \EG)$ is a \emphw{$\CC$-local $(1+\eps)$-spanner}
...
\begin{defn}[\cite{cd-vdbcdf-85}]
    ...
    for $\CC$, the \emphi{$\CC$-Delaunay triangulation} of $\PS$,
