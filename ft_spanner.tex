...
Thus, for $\PS\subseteq \Re^d$, the grap h $\G$ is a
\emphw{$t$-spanner} of $\PS$ if it is a $t$-spanner of $\G_\PS$.
...
\cite{ns-gsn-07} -- that is, constructing Euclidean graphs that
$t$-preserve distances.  Recently, Abam and Borouny \cite{ab-lgs-21}
