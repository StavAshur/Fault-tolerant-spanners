...
\begin{lemma}
    \lemlab{l:s:lower:bound}[Proof in
    \apndref{l:s:lower:bound:proof}] %
    %
    \LemmaDiskLowerBound
...
\begin{figure}[h]
	...
	\caption{ An illustration of the shrinking process of
           \lemref{shrink:triangles}. The three left subfigures are an
           activation of \lemref{shrink:shrank} for the case that the
           convex region $\CC$ is a triangle, and the rightmost
           subfigure is the additional final step.}
