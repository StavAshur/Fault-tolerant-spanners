...
\providecommand{\ESAVer}[1]{}%
\providecommand{\NotESAVer}[1]{#1}%
\else%
...
\hideLIPIcs 
\providecommand{\ESAVer}[1]{#1}%
\providecommand{\NotESAVer}[1]{}%
\fi
...
%   Stav: changed this because of some option clash (it is USenglish at the top)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ESA Style: Defining theorem like environments
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
