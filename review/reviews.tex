...
\reviewCX{The opening line of the abstract contains eight commas, leading to a very fragmented sentence. Some commas should be removed, but I suggest to break up the sentence anyway.} Removed several commas.

\reviewCX{L23: capitalize euclidean} Done.

\reviewCX{L29: improve grammar (clause with "that")} Done.

\reviewCX{L47: improve grammar ("are further extend")} Done.

\reviewCX{L52-53: improve grammar (plural with s, or singular with an article)} Done.

\reviewCX{L106: replace the period by a comma} Done.

\reviewCX{L132: remove  the comma} Done.

\reviewCX{L146: The statement "We believe this decomposition might be useful" is strange, given that you use it to get your results.} Changed to "This
decomposition is very useful in this scenario and We believe
it may be of independent interest."

\reviewCX{L162: improve grammar (clause with "that")} Done.

\reviewCX{L164: there is a period at the end, but the sentence continues on line 165.} Done.

\reviewCX{L212: "Formally" suggests that the first part of Definition 10 is not formal, but I think it is formally defined already.} Changed to "More formally"

\reviewCX{L217: "or" should be "of"} Done.

\reviewCX{L228: a comma followed by a capital} Done.

\reviewCX{L226-241: This is one of the few proofs given in the main paper, but this proof is rather standard and not very interesting.} Not sure what to do about this.

\reviewCX{L242: Improve grammar} Done.

\reviewCX{L260-265: Isn't this known, or a direct modification of an existing proof? It does not seem the most important proof to give in the main part of the paper.} Not sure what to do.

\reviewCX{L268: "close" should be "closed"} Done.

\reviewCX{L275, 282: The paper cites Lemma 4, suggesting that the result follows from this paper, but Lemma 4 appears in [1], so these results really follow from previously known results}.
